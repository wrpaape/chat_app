...
class Message < ActiveRecord::Base
  ...
  def chatbot(user_id, chatroom_id, command, chatbot_hash)
    ...
    current_chatroom = Chatroom.find(chatroom_id)
    ...
    when :lolbomb
      ...
      num_bombs.times do
        res = Net::HTTP.post_form(uri, 'q' => 'ruby', 'body' => resp, 'user_id' => chatbot.id, 'chatroom_id' => chatroom_id)
        puts res.body
        sleep(1)
